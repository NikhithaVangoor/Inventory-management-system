...
<head>
  ...
  <style>
    ...
    body {
      ...
      margin: 0;
      padding: 0;
      background-image: url('supp_page.jpg');
...
<body>
  <div class="container">
    ...
    <header>
      <center><h1>Supplier Page</h1></center><br><br>
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<div class='product'>";
                    ...
                    echo "<h3>Material Type: $material_type</h3>";
                    echo "<p><strong>Material ID:</strong> $material_id</p>";
                    echo "<p><strong>Quantity:</strong> $quantity</p>";
                    echo "<form action='accept_order.php' method='post'>";
                    echo "<input type='hidden' name='material_id' value='$material_id'>";
                    echo "<input type='submit' value='Accept Order'>";
                    echo "</form>";
